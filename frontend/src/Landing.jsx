...
export default function Landing() {
  ...
  return (
    <div style={{ background: "#fafbff", color: "#0f0f23", fontFamily: "'Inter', sans-serif", minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{
            ...
            <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "9px", fontWeight: 900, color: "#93c5fd", letterSpacing: "-0.5px" }}>&lt;/&gt;</span>
          </div>
          <span style={{
            fontFamily: "'Outfit', sans-serif", fontWeight: 800, fontSize: "17px", letterSpacing: "0.05em",
        ...
        <div style={{ display: "flex", gap: "32px", alignItems: "center" }}>
          {["Features", "How It Works", "Stack"].map(l => (
            <a key={l} href={`#${l.toLowerCase().replace(/\s+/g, "-")}`}
              style={{ color: "#6b7280", fontSize: "14px", textDecoration: "none", fontWeight: 500, transition: "color 0.2s" }}
      ...
      <section style={{
        ...
        <div>
          <div style={{
            ...
            background: BLUE_LT, border: `1px solid ${BLUE_BD}`,
            marginBottom: "28px", fontSize: "12px", color: BLUE, fontWeight: 600,
          }}>
          ...
          <h1 style={{
            fontFamily: "'Outfit', sans-serif", fontSize: "clamp(36px, 5vw, 60px)",
            fontWeight: 900, lineHeight: 1.08, letterSpacing: "-0.03em", marginBottom: "24px",
          }}>
            <span style={{ color: "#0f0f23" }}>The AI that</span><br />
            <span style={{ background: `linear-gradient(135deg, ${BLUE_DK} 0%, ${BLUE} 50%, #06b6d4 100%)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>builds software</span><br />
            <span style={{ color: "#0f0f23" }}>for you.</span>
          </h1>

          <p style={{ fontSize: "17px", color: "#6b7280", lineHeight: 1.7, marginBottom: "40px", maxWidth: "440px" }}>
            Describe what you want to build. ARCHON's five specialized agents plan,
            write, review, execute and self-heal — completely autonomously.
          </p>
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            <button
              ...
              style={{
                ...
                background: BTN.bg, color: "#fff", fontSize: "15px", fontWeight: 700,
          ...
          <div style={{ marginTop: "40px", display: "flex", gap: "32px" }}>
            {[["5", "AI Agents"], ["100%", "Autonomous"], ["0", "Setup needed"]].map(([val, label]) => (
              <div key={label}>
                <div style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 800, fontSize: "24px", color: "#0f0f23" }}>{val}</div>
        ...
        {/* Right — Animated Hero Terminal (same style as Live Generation section) */}
        <div style={{
          ...
          {/* Chrome bar */}
          <div style={{ background: "#1c1c28", padding: "10px 16px", display: "flex", alignItems: "center", gap: "7px", borderBottom: "1px solid #2a2a3a" }}>
            ...
            <span style={{ marginLeft: "10px", fontSize: "10px", color: "#52526a", fontFamily: "JetBrains Mono, monospace" }}>ARCHON — pipeline</span>
            <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "5px" }}>
              <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#34d399", animation: "pulse 1.5s infinite" }} />
              <span style={{ fontSize: "9px", color: "#34d399", fontFamily: "JetBrains Mono, monospace" }}>live</span>
            </div>
          </div>
          {/* Log lines */}
          <div style={{ background: "#09090f", padding: "16px 20px", fontFamily: "JetBrains Mono, monospace", fontSize: "12px", lineHeight: 1.9, minHeight: "280px" }}>
            {HERO_LINES.map((line, i) => (
              <div key={i} style={{
                ...
                {i === HERO_LINES.length - 1 && (
                  <span style={{ display: "inline-block", width: "2px", height: "12px", background: BLUE, animation: "blink 1s step-end infinite", verticalAlign: "middle", marginLeft: "2px" }} />
                )}
              </div>
            ))}
          </div>
      ...
      {/* ── Animated Demo "Video" ──────────────────────────────── */}
      <section style={{ padding: "80px 24px", background: "#fff", borderTop: "1px solid #f0f2fa", borderBottom: "1px solid #f0f2fa" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto", textAlign: "center" }}>
          <p style={{ fontSize: "12px", color: BLUE, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "12px" }}>Demo</p>
          <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "clamp(24px, 3.5vw, 40px)", fontWeight: 800, letterSpacing: "-0.02em", marginBottom: "40px" }}>
            See ARCHON in action
          </h2>

          {/* Simulated screen recording */}
          <div style={{ borderRadius: "16px", overflow: "hidden", boxShadow: "0 24px 64px rgba(0,0,0,0.16)", border: "1px solid #1e1e2e", textAlign: "left" }}>

            {/* Browser / recording chrome */}
            <div style={{ background: "#111118", padding: "10px 18px", display: "flex", alignItems: "center", gap: "8px", borderBottom: "1px solid #1e1e2e" }}>
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#f87171" }} />
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#fbbf24" }} />
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#34d399" }} />
              <span style={{ marginLeft: "10px", fontSize: "11px", color: "#52526a", fontFamily: "JetBrains Mono, monospace", flex: 1 }}>localhost:5173/app</span>
              {/* Recording indicator */}
              <div style={{ display: "flex", alignItems: "center", gap: "6px", padding: "3px 10px", borderRadius: "100px", background: "rgba(248,113,113,0.12)", border: "1px solid rgba(248,113,113,0.3)" }}>
                <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#f87171", animation: "pulse 1s infinite" }} />
                <span style={{ fontSize: "10px", color: "#f87171", fontFamily: "JetBrains Mono, monospace", fontWeight: 700 }}>REC</span>
              </div>
            </div>

            {/* ARCHON app simulation — sidebar + editor */}
            <div style={{ display: "grid", gridTemplateColumns: "220px 1fr", background: "#09090f", minHeight: "420px" }}>

              {/* ── Sidebar ── */}
              <div style={{ borderRight: "1px solid #1e1e2e", display: "flex", flexDirection: "column", padding: "0" }}>
                {/* Logo */}
                <div style={{ padding: "14px 16px", borderBottom: "1px solid #1e1e2e", display: "flex", alignItems: "center", gap: "8px" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "6px", background: "linear-gradient(135deg, #1d4ed8, #2563eb)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "7px", fontWeight: 900, color: "#93c5fd" }}>&lt;/&gt;</span>
                  </div>
                  <span style={{ fontFamily: "'Outfit', sans-serif", fontWeight: 700, fontSize: "13px", background: "linear-gradient(135deg, #c7d2fe, #93c5fd)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>ARCHON</span>
                  <div style={{ marginLeft: "auto", width: "6px", height: "6px", borderRadius: "50%", background: "#34d399", animation: "pulse 2s infinite" }} />
                </div>

                {/* Task progress */}
                <div style={{ padding: "12px 14px", borderBottom: "1px solid #1e1e2e" }}>
                  <div style={{ fontSize: "9px", color: "#52526a", fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "8px" }}>Task Progress</div>
                  {["index.html", "style.css", "script.js"].map((f, i) => (
                    <div key={f} style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "5px", opacity: 0, animation: `fadeSlide 0.3s ${1.5 + i * 0.6}s forwards` }}>
                      <span style={{ color: i < 2 ? "#34d399" : "#fbbf24", fontSize: "10px" }}>{i < 2 ? "✓" : "●"}</span>
                      <span style={{ fontSize: "11px", color: i < 2 ? "#ededf0" : "#fbbf24", fontFamily: "JetBrains Mono, monospace" }}>{f}</span>
                    </div>
                  ))}
                </div>
                ...
                <div style={{ padding: "12px 14px", flex: 1, overflow: "hidden" }}>
                  ...
                  {[
                    ...
                    <div key={i} style={{ display: "flex", gap: "5px", alignItems: "flex-start", marginBottom: "4px", opacity: 0, animation: `fadeSlide 0.3s ${l.delay}s forwards` }}>
                      ...
                      <span style={{ fontSize: "10px", color: "#8a8a9a", fontFamily: "JetBrains Mono, monospace", lineHeight: 1.4 }}>{l.msg}</span>
                    </div>
                  ))}
                </div>

                {/* Status bar */}
                <div style={{ padding: "10px 14px", borderTop: "1px solid #1e1e2e", opacity: 0, animation: "fadeSlide 0.4s 4.2s forwards" }}>
                  <div style={{ fontSize: "10px", color: "#34d399", fontFamily: "JetBrains Mono, monospace", display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                {/* Tab bar */}
                <div style={{ borderBottom: "1px solid #1e1e2e", padding: "0 16px", display: "flex", gap: "0", background: "#0f0f18" }}>
                  {["index.html", "style.css"].map((tab, i) => (
                    <div key={tab} style={{ padding: "10px 16px", fontSize: "11px", fontFamily: "JetBrains Mono, monospace", color: i === 0 ? "#ededf0" : "#52526a", borderBottom: i === 0 ? `2px solid ${BLUE}` : "2px solid transparent", opacity: 0, animation: `fadeSlide 0.3s ${1.0 + i * 0.4}s forwards` }}>{tab}</div>
                  ))}
                </div>
                ...
                <div style={{ padding: "16px 20px", fontFamily: "JetBrains Mono, monospace", fontSize: "12px", lineHeight: 1.85, flex: 1 }}>
                  {[
                    ...
                    { n: 13, color: "#34d399", text: "    <!-- ✅ CRITIC PASS -->" },
                  ].map((line, i) => (
                    <div key={i} style={{ display: "flex", gap: "16px", opacity: 0, animation: `fadeSlide 0.25s ${1.3 + i * 0.12}s forwards` }}>
                      <span style={{ color: "#2a2a3a", minWidth: "16px", textAlign: "right", userSelect: "none" }}>{line.n}</span>
                      <span style={{ color: line.color }}>{line.text}</span>
                      {i === 12 && <span style={{ display: "inline-block", width: "2px", height: "13px", background: BLUE, animation: "blink 1s step-end infinite", verticalAlign: "middle" }} />}
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section id="how-it-works" style={{ padding: "100px 24px" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          >
            <p style={{ fontSize: "12px", color: BLUE, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "12px" }}>How It Works</p>
            ...
            {AGENTS.map((agent, i) => (
              <motion.div key={agent.label} variants={fadeInUp} style={{ flex: 1 }}>
                <div style={{
                  ...
                  onMouseEnter={e => { e.currentTarget.style.boxShadow = `0 12px 28px ${agent.color}20`; e.currentTarget.style.transform = "translateY(-4px)"; }}
                  onMouseLeave={e => { e.currentTarget.style.boxShadow = "0 2px 12px rgba(0,0,0,0.05)"; e.currentTarget.style.transform = "translateY(0)"; }}
                >
                  <div style={{ width: "44px", height: "44px", borderRadius: "10px", background: agent.color + "15", border: `1px solid ${agent.color}30`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px", color: agent.color, margin: "0 auto 16px" }}>{agent.icon}</div>
                  <div style={{ fontWeight: 700, fontSize: "14px", color: "#0f0f23", marginBottom: "8px", fontFamily: "'Outfit', sans-serif" }}>{agent.label}</div>
                  <div style={{ fontSize: "12px", color: "#6b7280", lineHeight: 1.5 }}>{agent.desc}</div>
                </div>
              </motion.div>
            ))}
          </motion.div>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            variants={fadeInUp}
            style={{ marginTop: "32px", padding: "14px 24px", borderRadius: "10px", background: "#fffbeb", border: "1px solid #fde68a", display: "flex", alignItems: "center", gap: "12px" }}
          >
            <span style={{ color: "#f59e0b", fontSize: "18px" }}>↺</span>
            <span style={{ fontSize: "13px", color: "#78716c" }}>
              <span style={{ color: "#d97706", fontWeight: 600 }}>Self-healing loop: </span>
              If Critic rejects the code, Coder retries with exact feedback — up to 3 times before escalating to you.
            </span>
          </motion.div>
        </div>
      </section>
      ...
      <section style={{ padding: "100px 24px", background: "#fff" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          ...
          >
            <p style={{ fontSize: "12px", color: BLUE, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "12px" }}>Live Generation</p>
            <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "clamp(24px, 3.5vw, 40px)", fontWeight: 800, letterSpacing: "-0.02em" }}>Watch it build, file by file.</h2>
          </motion.div>
          ...
          >
            {/* Terminal chrome */}
            <div style={{
              background: "#1c1c28", padding: "12px 18px",
              ...
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#fbbf24" }} />
              <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#34d399" }} />
              <span style={{ marginLeft: "12px", fontSize: "11px", color: "#52526a", fontFamily: "JetBrains Mono, monospace" }}>ARCHON — coder_node · portfolio.py</span>
              {/* Live pulse */}
              <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "6px" }}>
                <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#34d399", animation: "pulse 1.5s infinite" }} />
                <span style={{ fontSize: "10px", color: "#34d399", fontFamily: "JetBrains Mono, monospace" }}>generating</span>
              </div>
            </div>

            {/* Code area */}
            <div style={{ background: "#09090f", padding: "24px", fontFamily: "JetBrains Mono, monospace", fontSize: "13px", lineHeight: 1.8 }}>
              {/* Agent status row */}
              <div style={{ display: "flex", gap: "8px", marginBottom: "20px", flexWrap: "wrap" }}>
                {[
                  ...
                  <span key={a.name} style={{
                    ...
                    color: a.done ? "#34d399" : a.active ? a.color : "#52526a",
                    background: a.done ? "rgba(52,211,153,0.12)" : a.active ? `${a.color}15` : "rgba(255,255,255,0.03)",
                    border: `1px solid ${a.done ? "#34d399" : a.active ? a.color : "#1e1e2e"}`,
                    animation: a.active ? "activeGlow 2s infinite" : "none",
                  }}>{a.done ? "✓ " : a.active ? "● " : ""}{a.name}</span>
                ))}
              </div>
              ...
              {CODE_LINES.map((line, i) => (
                <div key={i} style={{
                  ...
                  <span style={{ color: "#2a2a3a", userSelect: "none", minWidth: "20px", textAlign: "right", fontSize: "11px" }}>{i + 1}</span>
                  <span>{line.text}</span>
                  {/* Blinking cursor on last line */}
                  {i === CODE_LINES.length - 1 && (
                    <span style={{ display: "inline-block", width: "2px", height: "14px", background: BLUE, animation: "blink 1s step-end infinite", verticalAlign: "middle" }} />
                  )}
                </div>
              ))}
            </div>
      ...
      <section id="features" style={{ padding: "100px 24px", background: "#f8f8fc" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <motion.div 
            ...
            style={{ textAlign: "center", marginBottom: "56px" }}
          >
            <p style={{ fontSize: "12px", color: BLUE, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "12px" }}>Features</p>
          ...
          >
            {FEATURES.map(f => (
              <motion.div 
                ...
                onMouseEnter={e => { e.currentTarget.style.boxShadow = `0 12px 28px ${f.color}15`; e.currentTarget.style.transform = "translateY(-4px)"; }}
                onMouseLeave={e => { e.currentTarget.style.boxShadow = "0 2px 8px rgba(0,0,0,0.04)"; e.currentTarget.style.transform = "translateY(0)"; }}
              >
                <div style={{ width: "44px", height: "44px", borderRadius: "12px", background: f.bg, border: `1px solid ${f.color}25`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "20px", color: f.color, marginBottom: "16px" }}>{f.icon}</div>
                <h3 style={{ fontWeight: 700, fontSize: "16px", marginBottom: "8px", fontFamily: "'Outfit', sans-serif", color: "#0f0f23" }}>{f.title}</h3>
      ...
      <section id="stack" style={{ padding: "100px 24px", background: "#f8f8fc" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <p style={{ fontSize: "12px", color: BLUE, fontWeight: 700, letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: "12px" }}>Stack</p>
          ...
          >
            {STACK.map(s => (
              ...
              >
                <div style={{ fontSize: "13px", fontWeight: 700, color: s.color, marginBottom: "4px", fontFamily: "'JetBrains Mono', monospace" }}>{s.name}</div>
                <div style={{ fontSize: "12px", color: "#9ca3af" }}>{s.role}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section style={{ padding: "120px 24px 140px", textAlign: "center", background: "#fff" }}>
        ...
        >
          <h2 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "clamp(28px, 4vw, 52px)", fontWeight: 900, letterSpacing: "-0.03em", marginBottom: "16px", color: "#0f0f23" }}>
            Ready to build something?
          </h2>
          <p style={{ color: "#6b7280", fontSize: "17px", marginBottom: "40px", lineHeight: 1.6 }}>Describe it in plain English. ARCHON handles the rest.</p>
          <button
            onClick={() => navigate("/app")}
            style={{
              padding: "16px 52px", borderRadius: "12px", border: "none", cursor: "pointer",
              background: BTN.bg, color: "#fff", fontSize: "16px", fontWeight: 700,
      ...
      {/* ── Footer ───────────────────────────────────────── */}
      <footer style={{ padding: "28px 48px", borderTop: "1px solid #e8eaf6", display: "flex", justifyContent: "space-between", alignItems: "center", background: "#fafbff", flexWrap: "wrap", gap: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <div style={{ width: "24px", height: "24px", borderRadius: "6px", background: `linear-gradient(135deg, ${BLUE_DK}, ${BLUE})`, display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "7px", fontWeight: 900, color: "#93c5fd" }}>&lt;/&gt;</span>
          </div>
